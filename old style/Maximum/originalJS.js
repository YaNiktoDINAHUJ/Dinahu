...
const oneasHud = {
  ...
  <div class="ONEAS-hud__wanted ${oneasHud.wantedAlwaysShowClass}">
    <div class="ONEAS-wanted__row"><img src="images/hud/wanted_inactive.svg" alt="" class="ONEAS-wanted__inactive"> <img src="images/hud/wanted_inactive.svg" alt="" class="ONEAS-wanted__inactive"> <img src="images/hud/wanted_inactive.svg" alt="" class="ONEAS-wanted__inactive"> <img src="images/hud/wanted_active.svg" alt="" class="ONEAS-wanted__active"> <img src="images/hud/wanted_active.svg" alt="" class="ONEAS-wanted__active"> <img src="images/hud/wanted_active.svg" alt="" class="ONEAS-wanted__active"></div>
  </div>
</div>
...
<div class="ONEAS-hud__radar-border"><img src="images/hud/border.png" class="ONEAS-radar__images"></div>`;
    ...
    speedometer: {
        ...
        show() {
            ...
            //document.querySelector('.ONEAS-speedometer__progress-bar').style.opacity = '1';
        ...
        hide() {
            ...
            //document.querySelector('.ONEAS-speedometer__progress-bar').style.opacity = '0';
            //this.data.speedometerEl.style.bottom = '-700px';
            //this.data.speedometerEl.style.opasity = '0';
        },
        setGear(value) {
            const htmlValues = this.getBigSizeValue(value);
            this.data.tachometer.gearEl.innerHTML = htmlValues;
        },
        setTachometer(rpm, maxRpm) {
            ...
            if (window.interface("Hud").speedometer.tachometer.show && rpm / maxRpm > 0.5) {
                this.data.tachometer.barEl.src = `images/speed/arrow-glow.png`;
            } else {
                this.data.tachometer.barEl.src = `images/speed/arrow.png`;
            }
        ...
        setSpeed(speed) {
            const htmlValues = this.getBigSizeValue(speed);
            const maxSpeed = 360;
            this.data.speed.valueEl.innerHTML = htmlValues;

            if (speed > maxSpeed) speed = maxSpeed;

            const deg = (speed / maxSpeed) * this.barsValues.speed.dashArray;
        ...
        setDamage(floatDamage) {
            ...
            this.data.damage.progress.style.width = `${Math.floor(floatDamage * 100)}%`;
        },
        setWash(floatWash) {
            this.data.wash.progress.style.width = `${Math.floor(floatWash * 100)}%`;
        },
        setFuel(fuel) {
            const htmlValues = this.getSmallSizeValue(fuel);
            const maxFuel = window.interface("Hud").speedometer.maxFuel;
            const valueBar = (fuel / maxFuel) * 100;
            const valueColor = valueBar <= 5 ? "#DB2C22" : valueBar <= 25 ? "#DB4222" : valueBar <= 35 ? "#DB7122" : valueBar <= 50 ? "#DB9C22" : valueBar <= 65 ? "#CFC023" : valueBar <= 80 ? "#9FC42B" : valueBar <= 90 ? "#6CC733" : "#3ACB3B";

            this.data.fuel.valueEl.innerHTML = htmlValues;
            this.data.fuel.progress.style.width = `${valueBar}%`;
            this.data.fuel.progress.style.backgroundColor = valueColor;
        },
        getSmallSizeValue(value) {
            const stringValue = value.toString().split("");
            let resHTML = "";

            for (let i = 0; i < stringValue.length; i += 1) {
                resHTML += `<img class="ONEAS-digit ONEAS-digit-${stringValue[i]} ONEAS-digit-small" src="images/speed/${stringValue[i]}.png" alt="" srcset="">`;
            }

            return resHTML;
        },
        getBigSizeValue(value) {
            const stringValue = value.toString().split("");
            let resHTML = "";

            for (let i = 0; i < stringValue.length; i += 1) {
                resHTML += `<img class="ONEAS-digit ONEAS-digit-${stringValue[i]} ONEAS-digit-big" src="images/speed/${stringValue[i]}.png" alt="" srcset="">`;
            }
        ...
        create(speedometerEl) {
            ...
            this.data.fuel.progress = speedometerEl.querySelector(".ONEAS-fuel-bar__value");

            // WASH
            this.data.wash.progress = speedometerEl.querySelector(".ONEAS-wash-bar__value");
    ...
    <img class="ONEAS-tachometer__arrow" src="images/speed/arrow.png" alt="">
    <div class="ONEAS-tachometer__data">
        <div id="ONEAS-tachometer-gear">        
            <img class="ONEAS-digit ONEAS-digit-0 ONEAS-digit-big" src="images/speed/0.png" alt="">
        </div>
    </div>
</div>
<img class="ONEAS-speedometer-bg" src="images/speed/back.png" alt="" srcset="">
<div class="ONEAS-speedometer__speed"><img class="ONEAS-speedometer-speed__arrow" src="images/speed/arrow.png" alt="" srcset="">
  <div class="ONEAS-speedometer-speed__data"><span class="ONEAS-speedometer-speed__value"><img class="ONEAS-digit ONEAS-digit-0 ONEAS-digit-big" src="images/speed/0.png" alt="" srcset=""></span></div>
</div>
<div class="ONEAS-speedometer__mileage"><span class="ONEAS-speedometer-mileage__value"><img class="ONEAS-digit ONEAS-digit-0 ONEAS-digit-big" src="images/speed/0.png" alt="" srcset=""> <img class="ONEAS-digit ONEAS-digit-0 ONEAS-digit-big" src="images/speed/0.png" alt="" srcset=""> <img class="ONEAS-digit ONEAS-digit-0 ONEAS-digit-big" src="images/speed/0.png" alt="" srcset=""> <img class="ONEAS-digit ONEAS-digit-0 ONEAS-digit-big" src="images/speed/0.png" alt="" srcset=""> <img class="ONEAS-digit ONEAS-digit-0 ONEAS-digit-big" src="images/speed/0.png" alt="" srcset=""> <img class="ONEAS-digit ONEAS-digit-0 ONEAS-digit-big" src="images/speed/0.png" alt="" srcset=""></span><img class="ONEAS-speedometer-mileage__icon" src="images/speed/km.png" alt="" srcset=""></div>
...
<div class="ONEAS-speedometer__fuel">
  <div class="ONEAS-speedometer-fuel__data ONEAS-speedometer-data">
    ...
    <div class="ONEAS-speedometer-fuel__value"><img class="ONEAS-digit ONEAS-digit-5 ONEAS-digit-small" src="images/speed/5.png" alt="" srcset=""> <img class="ONEAS-digit ONEAS-digit-4 ONEAS-digit-small" src="images/speed/4.png" alt="" srcset=""></div>
    <div class="ONEAS-speedometer-fuel__bar">
      <div class="ONEAS-fuel-bar__value"></div>
    </div>
  </div>
</div>
<div class="ONEAS-speedometer__progress-bar">
  <div class="ONEAS-speedometer__damage">
    <div class="ONEAS-speedometer-damage__data">
      <div class="ONEAS-speedometer-damage__icon"><img class="ONEAS-damage__icon" src="images/speed/damage.png" alt="" srcset=""></div>
      <div class="ONEAS-speedometer-damage__bar">
        <div class="ONEAS-damage-bar__value"></div>
      </div>
    </div>
  </div>
  <div class="ONEAS-speedometer__wash">
    <div class="ONEAS-speedometer-wash__data">
      <div class="ONEAS-speedometer-wash__icon"><img class="ONEAS-wash__icon" src="images/speed/wash.png" alt="" srcset=""></div>
      <div class="ONEAS-speedometer-wash__bar">
        <div class="ONEAS-wash-bar__value"></div>
      </div>
    </div>
  </div>
</div>`;

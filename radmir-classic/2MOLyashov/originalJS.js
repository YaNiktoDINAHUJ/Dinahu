  ...
  hud: {
    ...
    onInfoChange(prop, value) {
      ...
      if (prop == 'weapon') {
        ...
        if ((value == 0) | (value == 24) | (value == 25) | (value == 29) | (value == 30) | (value == 31) | (value == 33) | (value == 34)) (document.querySelector('.ONEAS-weapon__icon').style.width = '');
     else (document.querySelector('.ONEAS-weapon__icon').style.width = '138px');

     if (value == 0) document.querySelector('.ONEAS-weapon__icon').style.top = '111px', document.querySelector('.ONEAS-weapon__icon').style.right = '';
          else if ((value == 24) | (value == 25) | (value == 29) | (value == 30) | (value == 31) | (value == 33) | (value == 34)) (document.querySelector('.ONEAS-weapon__icon').style.top = '', document.querySelector('.ONEAS-weapon__icon').style.right = '');

    ...
    hud: {
        ...
        onInfoChange(prop, value) {
            ...
            if (prop == "weapon") {
              ...
              // if ((value == 0) | (value == 1) | (value == 3) | (value == 4) | (value == 5) | (value == 6) | (value == 14) | (value == 24) | (value == 25) | (value == 30) | (value == 31) | (value == 33) | (value == 34) | (value == 42) | (value == 43)) (document.querySelector(".ONEAS-weapon__icon").style.top = "130px"), (document.querySelector(".ONEAS-weapon__icon").style.right = "68px");

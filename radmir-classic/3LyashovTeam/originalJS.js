  ...
  hud: {
    ...
    onInfoChange(prop, value) {
      ...
      if (prop == 'weapon') {
        ...
        if ((value == 0) | (value == 24) | (value == 25) | (value == 31)) (document.querySelector('.ONEAS-weapon__icon').style.width = '');
     else (document.querySelector('.ONEAS-weapon__icon').style.width = '138px');

     if (value == 0) document.querySelector('.ONEAS-weapon__icon').style.top = '105px', document.querySelector('.ONEAS-weapon__icon').style.right = '44px';
          else if ((value == 0) | (value == 24) | (value == 25) | (value == 31)) (document.querySelector('.ONEAS-weapon__icon').style.top = '', document.querySelector('.ONEAS-weapon__icon').style.right = '');
          else document.querySelector('.ONEAS-weapon__icon').style.top = '132px', document.querySelector('.ONEAS-weapon__icon').style.right = '68px';
      ...
      <div class="ONEAS-speedometer__params">
         ...
         <div class="ONEAS-speedometer__main">
           ...
           <div class="ONEAS-speedometer__speed">
             ...
             <path d="M52.6632 188.714C40.5128 174.788 32.6143 157.668 29.9058 139.386C27.1973 121.104 29.7926 102.429 37.3834 85.5784C44.9743 68.7279 57.2418 54.41 72.729 44.325C88.2163 34.24 106.273 28.8118 124.754 28.6849C143.234 28.558 161.364 33.7378 176.988 43.6092C192.612 53.4805 205.075 67.6287 212.897 84.3734C220.718 101.118 223.57 119.756 221.112 138.073C218.655 156.39 210.992 173.618 199.034 187.709" stroke="url(#paint0_linear_2353_2)" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/>
             <defs>
             ...
             <path d="M52.6686 188.72C40.5166 174.795 32.6165 157.674 29.9067 139.392C27.1969 121.11 29.7912 102.434 37.3815 85.5826C44.9718 68.7312 57.2392 54.4123 72.7267 44.3266C88.2141 34.2408 106.271 28.812 124.752 28.6849C143.234 28.5578 161.364 33.7378 176.988 43.6096C192.613 53.4813 205.076 67.6302 212.898 84.3756C220.719 101.121 223.57 119.76 221.112 138.077C218.654 156.395 210.99 173.623 199.03 187.714" stroke="black" stroke-opacity="0.5" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/>
             </svg>
             
             
               <svg class="ONEAS-damage__bar" width="278" height="278" viewBox="0 0 278 278" fill="none" xmlns="http://www.w3.org/2000/svg">
                 <path d="M31.7773 139.778C31.7773 125.543 34.5911 111.45 40.0569 98.3067C45.5227 85.1637 53.5326 73.2308 63.6261 63.1943C73.7196 53.1577 85.6976 45.2153 98.8712 39.824C112.045 34.4326 126.154 31.6986 140.388 31.7791" stroke="url(#paint0_linear_2071_131)" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" />
                 <defs>
               ...
               <svg class="ONEAS-damage__bar-bg" width="278" height="278" viewBox="0 0 278 278" fill="none" xmlns="http://www.w3.org/2000/svg">
                 <path d="M31.7773 139.778C31.7773 125.541 34.5922 111.444 40.0601 98.299C45.5279 85.1539 53.5408 73.2196 63.6379 63.1826C73.7349 53.1456 85.7167 45.204 98.8942 39.8146C112.072 34.4252 126.185 31.6944 140.421 31.7793" stroke="black" stroke-opacity="0.5" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" />
               </svg>  

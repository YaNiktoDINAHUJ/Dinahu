...
const oneasHud = {
    ...
    hud: {
        ...
        onInfoChange(prop, value) {
            ...
            if (prop === "isShowFreeze" && value) {
                ...
                document.querySelector(".ONEAS-hud__params").style.bottom = "13px";
                document.querySelector(".ONEAS-hud__params").style.gap = "0.2vh";
              }
        
              if (prop === "isShowFreeze" && !value) {
                this.data.freezeEl.wrapper.style.display = 'none';
                document.querySelector(".ONEAS-hud__params").style.bottom = "27px";
                document.querySelector(".ONEAS-hud__params").style.gap = "1.5vh";
              }
  ...
  <div class="ONEAS-hud__params">
    <div class="ONEAS-param__health ONEAS-param"><img src="images/hud/health.svg" alt="" class="ONEAS-param__icon"><span class="ONEAS-param__amount">50</span></div>
    <div class="ONEAS-param__armour ONEAS-param"><img src="images/hud/armour.svg" alt="" class="ONEAS-param__icon"><span class="ONEAS-param__amount">0</span></div>
    <div class="ONEAS-param__hunger ONEAS-param"><img src="images/hud/hunger.svg" alt="" class="ONEAS-param__icon"><span class="ONEAS-param__amount">0</span></div>
    <div style="display: none" class="ONEAS-param__breath ONEAS-param"><span class="ONEAS-param__amount">0</span></div>
    <div style="display: none" class="ONEAS-param__freeze ONEAS-param"><img src="https://i.ibb.co/ZJS1V3G/freeze-icon-psg.png" alt="" class="ONEAS-param__icon"><span class="ONEAS-param__amount">0</span></div>
  </div>
  <div class="ONEAS-hud__green-zone"><img src="images/hud/zone.svg" alt="" class="ONEAS-green-zone__image">
    <div class="ONEAS-green-zone__text">
      <div>Безопасная зона</div>
    </div>
  </div><img src="images/hud/bottom_bg.png" class="ONEAS-bottom-bg"></div>
<div class="ONEAS-hud__top">
  <div class="ONEAS-hud__logo"><img src="images/logo/1.png" class="ONEAS-logo__image">
  ...
  <div class="ONEAS-hud__wanted">
  ...
  </div><img src="images/hud/top_bg.png" alt="" class="ONEAS-top-bg"></div>`;
    ...
    speedometer: {
        ...
        </div><img class="ONEAS-speedometer-bg" src="images/speed/sp-bg.png" alt="" srcset="">

...
const defaultAdditionalScripts = [
  ...
  },
  {
    name: 'Фото режим',
    id: 'PhotoMode',
    filePath: 'additional-scripts/PhotoMode.js',
    enabled: true,
    is_hidden: false,
  },
  {
...
const oneasHud = {
  ...
  hud: {
    ...
    createHud(hudEl) {
      ...
      this.data.server.value = hudEl.querySelector('.ONEAS-logo__title-3');
    ...
    init() {
      ...
      <div class="ONEAS-hud__bottom">
        <div class="ONEAS-hud__radar">
          <div class="ONEAS-hud__green-zone">
            <img src="images/hud/zone.svg" alt="" class="ONEAS-green-zone__image">
            <div class="ONEAS-green-zone__text">
              <div>Безопасная зона</div>
            </div>
          </div>
          <img src="images/hud/radar_border.png" class="ONEAS-radar__images">  
        </div>
  <div class="ONEAS-hud__params">
    <div class="ONEAS-param__health ONEAS-param"><img src="images/hud/health.png" alt="" class="ONEAS-param__icon"><span class="ONEAS-param__amount">50</span></div>
    <div class="ONEAS-param__armour ONEAS-param"><img src="images/hud/armour.png" alt="" class="ONEAS-param__icon"><span class="ONEAS-param__amount">0</span></div>
    <div class="ONEAS-param__hunger ONEAS-param"><img src="images/hud/hunger.png" alt="" class="ONEAS-param__icon"><span class="ONEAS-param__amount">0</span></div>
    <div class="ONEAS-param__breath ONEAS-param"><img src="images/hud/breath.png" alt="" class="ONEAS-param__icon"><span class="ONEAS-param__amount">0</span></div>
    <div style="display: none" class="ONEAS-param__freeze ONEAS-param"><img src="https://i.ibb.co/nPZTDrM/freeze-icon.png" alt="" class="ONEAS-param__icon"><span class="ONEAS-param__amount">0</span></div>
  </div>
  <div class="ONEAS-hud__time-data" style="">
...
<div class="ONEAS-hud__top">
  <div class="ONEAS-hud__logo">
    <div class="ONEAS-logo__text">
      <div class="ONEAS-logo__title"><span class="ONEAS-logo__title-1">Radmir</span><span class="ONEAS-logo__title-2">RP</span>
        <br><span class="ONEAS-logo__title-3">1</span><span class="ONEAS-logo__title-4">server</span></div>
    </div>
  ...
  <div class="ONEAS-hud__wanted ${oneasHud.wantedAlwaysShowClass}">
    <div class="ONEAS-wanted__row"><img src="images/hud/wanted_inactive.png" alt="" class="ONEAS-wanted__inactive"> <img src="images/hud/wanted_inactive.png" alt="" class="ONEAS-wanted__inactive"> <img src="images/hud/wanted_inactive.png" alt="" class="ONEAS-wanted__inactive"> <img src="images/hud/wanted_active.png" alt="" class="ONEAS-wanted__active"> <img src="images/hud/wanted_active.png" alt="" class="ONEAS-wanted__active"> <img src="images/hud/wanted_active.png" alt="" class="ONEAS-wanted__active"></div>
      ...
      window.interface('Hud').setBonus(interface('Hud').bonus);
      window.interface('Hud').setServer(interface('Hud').server);
      window.interface('Hud').info.health = interface('Hud').info.health;
      window.interface('Hud').info.armour = interface('Hud').info.armour;
      window.interface('Hud').info.hunger = interface('Hud').info.hunger;
      window.interface('Hud').info.breath = interface('Hud').info.breath;
      window.interface('Hud').info.ammoInClip = interface('Hud').info.ammoInClip;
      window.interface('Hud').info.totalAmmo = interface('Hud').info.totalAmmo;
      window.interface('Hud').info.money = interface('Hud').info.money;
      window.interface('Hud').info.wanted = 0;
      window.interface('Hud').info.weapon = interface('Hud').info.weapon;

...
const OneasHudTimeParams = {
    ...
    wrapperSelector: ".ONEAS-hud__time",
};
...
const oneasHud = {
  ...
  <div class="ONEAS-hud__logo">
    ...
    <img class="ONEAS-logo__bonus" src="images/logo/bonus-3.png">
  </div>
  <div class="ONEAS-hud__info">
    ...
    <div class="ONEAS-hud__time" style="">
    <div class="ONEAS-title">timer:</div>
    <div class="ONEAS-data"></div>
    <div class="ONEAS-time">19:32:25:123</div>
  </div>
    <div class="ONEAS-hud__wanted ${oneasHud.wantedAlwaysShowClass}">
      <div class="ONEAS-wanted__row">
        <img src="images/hud/wanted_inactive.png" alt="" id="ONEAS-wanted-1" class="ONEAS-wanted__inactive"> 
        <img src="images/hud/wanted_inactive.png" alt="" id="ONEAS-wanted-2" class="ONEAS-wanted__inactive"> 
        <img src="images/hud/wanted_inactive.png" alt="" id="ONEAS-wanted-3" class="ONEAS-wanted__inactive"> 
        <img src="images/hud/wanted_active.png" alt="" id="ONEAS-wanted-4" class="ONEAS-wanted__active"> 
...
<div class="ONEAS-hud__radar-border"><img src="images/hud/border.png" class="ONEAS-radar__images"></div></div>`;
    ...
    speedometer: {
        ...
        init() {
            const text = `<img class="ONEAS-speedometer-bg" src="images/speed/back.png" alt="" srcset=""><div class="ONEAS-speedometer__speed"><svg class="ONEAS-speedometer-speed__bar" width="159" height="147" viewBox="0 0 159 147" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M37.8181 144.837C23.7136 135.839 12.8996 122.518 6.99216 106.865C1.0847 91.2128 0.400993 74.0689 5.04322 57.9956C9.68544 41.9224 19.4043 27.7829 32.7474 17.6902C46.0905 7.5976 62.3413 2.09374 79.0713 2.00119C95.8012 1.90864 112.112 7.23237 125.566 17.1768C139.02 27.1212 148.895 41.1523 153.714 57.1732C158.534 73.1941 158.04 90.3446 152.306 106.061C146.572 121.778 135.906 135.218 121.902 144.371" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/></svg><svg class="ONEAS-speedometer-speed__bar-bg" width="159" height="147" viewBox="0 0 159 147" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M37.8181 144.837C23.7136 135.839 12.8996 122.518 6.99216 106.865C1.0847 91.2128 0.400993 74.0689 5.04322 57.9956C9.68544 41.9224 19.4043 27.7829 32.7474 17.6902C46.0905 7.5976 62.3413 2.09374 79.0713 2.00119C95.8012 1.90864 112.112 7.23237 125.566 17.1768C139.02 27.1212 148.895 41.1523 153.714 57.1732C158.534 73.1941 158.04 90.3446 152.306 106.061C146.572 121.778 135.906 135.218 121.902 144.371" stroke="black" stroke-opacity="0.5" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/></svg><div class="ONEAS-speedometer-speed__data"><span class="ONEAS-speedometer-speed__value">0</span><span class="ONEAS-speedometer-speed__text">км/ч</span></div></div><div class="ONEAS-speedometer__speed-params"><div class="ONEAS-speedometer__mileage"><span class="ONEAS-speedometer-mileage__value">000000</span></div><div class="ONEAS-speedometer__turns"><div class="ONEAS-speedometer-turn__left"></div><div class="ONEAS-speedometer-turn__right"></div></div></div><div class="ONEAS-speedometer__params"><div class="ONEAS-spedometer-param__lights ONEAS-spedometer-param--active"></div><div class="ONEAS-spedometer-param__key ONEAS-spedometer-param--active"></div><div class="ONEAS-spedometer-param__rem ONEAS-spedometer-param--active"></div><div class="ONEAS-spedometer-param__doors ONEAS-spedometer-param--active"></div></div><div class="ONEAS-speedometer__fuel"><div class="ONEAS-speedometer-fuel__icon"></div><div class="ONEAS-speedometer-data__text"><div class="ONEAS-speedometer-fuel__value">50</div><div class="ONEAS-speedometer-fuel__text ONEAS-speedometer-data__text">%</div></div></div><div class="ONEAS-speedometer__wash"><div class="ONEAS-speedometer-wash__icon"></div><div class="ONEAS-speedometer-data__wash"><svg class="ONEAS-speedometer-wash__bar" width="111" height="121" viewBox="0 0 111 121" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M105.56 2.07677C109.747 16.9547 110.118 32.6478 106.639 47.7071C103.16 62.7664 95.9438 76.7066 85.6554 88.2406C75.367 99.7747 62.3386 108.531 47.773 113.701C33.2074 118.871 17.574 120.287 2.31623 117.821" stroke="white" stroke-width="4" stroke-linecap="round"/></svg><svg class="ONEAS-speedometer-wash__bar-bg" width="111" height="121" viewBox="0 0 111 121" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M105.56 2.07677C109.747 16.9547 110.118 32.6478 106.639 47.7071C103.16 62.7664 95.9438 76.7066 85.6554 88.2406C75.367 99.7747 62.3386 108.531 47.773 113.701C33.2074 118.871 17.574 120.287 2.31623 117.821" stroke="black" stroke-opacity="0.5" stroke-width="4" stroke-linecap="round"/></svg></div></div><div class="ONEAS-speedometer__damage"><div class="ONEAS-speedometer-damage__icon"></div><div class="ONEAS-speedometer-data__damage"><svg class="ONEAS-speedometer-damage__bar" width="161" height="48" viewBox="0 0 161 48" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.93307 45.3214C11.111 32.2062 22.4612 21.3628 35.936 13.7921C49.4108 6.22137 64.5757 2.16748 80.0308 2.00465C95.4858 1.84183 110.733 5.57533 124.364 12.8605C137.995 20.1456 149.572 30.7475 158.024 43.6875" stroke="white" stroke-width="4" stroke-linecap="round"/></svg><svg class="ONEAS-speedometer-damage__bar-bg" width="161" height="48" viewBox="0 0 161 48" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2.93307 45.3214C11.111 32.2062 22.4612 21.3628 35.936 13.7921C49.4108 6.22137 64.5757 2.16748 80.0308 2.00465C95.4858 1.84183 110.733 5.57533 124.364 12.8605C137.995 20.1456 149.572 30.7475 158.024 43.6875" stroke="black" stroke-opacity="0.5" stroke-width="4" stroke-linecap="round"/></svg></div></div>`;
